...
// Scripts/Cards/AnotherITranscendence.cs
// 注册卡牌。如果要写自定义池看添加人物的开头
[Pool(typeof(SummitBellCardPool))]
public class AnotherITranscendence : CustomCardModel
{
    // 基础耗能
...
// 添加这一行，指定卡牌立绘路径
    ...
    public AnotherITranscendence() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    public CardModel GetTranscendenceTransformedCard() => ModelDb.Card<TestCard>(); // 实现方法。自己更改类型
}