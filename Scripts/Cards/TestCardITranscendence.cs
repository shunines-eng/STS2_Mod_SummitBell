...
public class TestCardITranscendence : CustomCardModel
{
...
// 添加这一行，指定卡牌立绘路径
    ...
    public TestCardITranscendence() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    {
        DynamicVars.Damage.UpgradeValueBy(8); // 升级后增加4点伤害
    }
